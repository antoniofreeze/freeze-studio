    ...
    corpo.innerHTML=`
      ...
      <div class="wrap">
        ...
        <div class="d-sezione">
          ...
          <div class="strip">${Array.from({length:12},(_,i)=>i+1).map(n=>`<img src="assets/casi/${c.id}/f${n}.jpg" alt="" loading="lazy" width="1600" height="2000" onerror="this.remove()">`).join('')}</div>
